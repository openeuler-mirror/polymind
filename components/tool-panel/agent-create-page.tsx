      ...
      <CardContent>
        <form onSubmit={handleFormSubmit} className="space-y-4">
          <div className="space-y-2">
            <label htmlFor="name" className="text-sm font-medium">智能体名称 <span className="text-destructive">*</span></label>
          ...
          <div className="space-y-2">
            <label htmlFor="modelId" className="text-sm font-medium">模型配置 <span className="text-destructive">*</span></label>
            <Select 
          ...
          <div className="space-y-2">
            <label htmlFor="mcpServerName" className="text-sm font-medium">MCP Server 名称</label>
            <Input
              id="mcpServerName"
              name="mcpServerName"
          ...
          <div className="space-y-2">
            <label htmlFor="mcpServerConfig" className="text-sm font-medium">MCP Server 配置</label>
            <textarea
              id="mcpServerConfig"
              ...
              className={`w-full rounded-md border px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 ${
                mcpConfigError ? 'border-destructive focus-visible:ring-destructive' : 'border-input focus-visible:ring-ring'
              }`}
              rows={4}
            />
            {mcpConfigError && (
